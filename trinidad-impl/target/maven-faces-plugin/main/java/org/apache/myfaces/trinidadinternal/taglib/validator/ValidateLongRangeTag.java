...
import org.apache.myfaces.trinidadinternal.validator.LongRangeValidator;
...
public class ValidateLongRangeTag extends ValidatorTag
{
  ...
  /**
   * Construct an instance of the ValidateLongRangeTag.
   */
  ...
  private void _setProperties(
    LongRangeValidator validator) throws JspException
  {
    if (_maximum != null)
    {
      ...
      {
        long value = TagUtils.getLong(_maximum);
    ...
    if (_minimum != null)
    {
      ...
      {
        long value = TagUtils.getLong(_minimum);
