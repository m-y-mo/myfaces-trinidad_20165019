...
public class ValidateDateTimeRangeTag extends ValidatorTag
{
  ...
  /**
   * Construct an instance of the ValidateDateTimeRangeTag.
   */
  ...
  {
    DateTimeRangeValidator validator = (DateTimeRangeValidator)super.createValidator();
    _setProperties(validator);
    return validator;
  }

  private void _setProperties(
    DateTimeRangeValidator validator) throws JspException
  {
    if (_maximum != null)
    {
      ...
      {
        Date value = TagUtils.getDateWithMaxTime(_maximum);
    ...
    if (_minimum != null)
    {
      ...
      {
        Date value = TagUtils.getDate(_minimum);
