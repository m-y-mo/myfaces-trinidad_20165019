 ...
 * </table>
 */
public class CoreForm extends UIXForm
{
  ...
  static public final PropertyKey USES_UPLOAD_KEY =
    TYPE.registerKey("usesUpload", Boolean.class, Boolean.FALSE);
  static public final PropertyKey AUTO_COMPLETE_KEY =
    TYPE.registerKey("autoComplete", String.class, "on");
  static public final PropertyKey DEFAULT_COMMAND_KEY =
    TYPE.registerKey("defaultCommand", String.class);
  static public final PropertyKey ONSUBMIT_KEY =
    TYPE.registerKey("onsubmit", String.class);
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreForm";

  /**
   * Construct an instance of the CoreForm.
   */
  public CoreForm()
  {
   ...
   *
   * @return  the new usesUpload value
   */
  final public boolean isUsesUpload()
  {
    return ComponentUtils.resolveBoolean(getProperty(USES_UPLOAD_KEY), false);
  }

  /**
   * Sets whether the form supports file upload.
   * 
   * @param usesUpload  the new usesUpload value
   */
  final public void setUsesUpload(boolean usesUpload)
  {
    setProperty(USES_UPLOAD_KEY, usesUpload ? Boolean.TRUE : Boolean.FALSE);
  }
  ...
  /**
   * Gets The id attribute of the command button whose action would be invoked by default for form submit on hitting enter on any of the input fields of the form.
   *
   * @return  the new defaultCommand value
   */
  final public String getDefaultCommand()
  {
    return ComponentUtils.resolveString(getProperty(DEFAULT_COMMAND_KEY));
  }

  /**
   * Sets The id attribute of the command button whose action would be invoked by default for form submit on hitting enter on any of the input fields of the form.
   * 
   * @param defaultCommand  the new defaultCommand value
   */
  final public void setDefaultCommand(String defaultCommand)
  {
    setProperty(DEFAULT_COMMAND_KEY, (defaultCommand));
  }
   ...
   */
  final public String getOnsubmit()
  {
    return ComponentUtils.resolveString(getProperty(ONSUBMIT_KEY));
  }
  ...
  {
    setProperty(ONSUBMIT_KEY, (onsubmit));
  }
