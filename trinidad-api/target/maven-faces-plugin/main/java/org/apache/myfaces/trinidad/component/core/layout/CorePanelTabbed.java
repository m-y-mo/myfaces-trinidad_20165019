 ...
 * </table>
 */
public class CorePanelTabbed extends UIXShowOne
{
  static public final String POSITION_ABOVE = "above";
  static public final String POSITION_BOTH = "both";
  static public final String POSITION_BELOW = "below";
  ...
  /**
   * Construct an instance of the CorePanelTabbed.
   */
  public CorePanelTabbed()
  {
    super("org.apache.myfaces.trinidad.Tab");
  }

  /**
   * Gets the position of the tab bar. Defaults to
  ...
  {
    return ComponentUtils.resolveString(getProperty(POSITION_KEY), "both");
  }

  /**
   * Sets the position of the tab bar. Defaults to
   *              "both", if not specified. Other values are "above" and "below".
   * 
