 ...
 * </table>
 */
public class CoreSelectRangeChoiceBar extends UIXSelectRange
{
  ...
  /**
   * Construct an instance of the CoreSelectRangeChoiceBar.
   */
  public CoreSelectRangeChoiceBar()
  {
   ...
   * Construct an instance of the CoreSelectRangeChoiceBar.
   */
  protected CoreSelectRangeChoiceBar(
    String rendererType
    )
  {
    super(rendererType);
