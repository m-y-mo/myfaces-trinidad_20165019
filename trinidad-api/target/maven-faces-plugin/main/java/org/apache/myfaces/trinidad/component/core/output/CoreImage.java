 ...
 * </table>
 */
public class CoreImage extends UIXObject
{
  static public final String IMAGE_MAP_TYPE_NONE = "none";
  static public final String IMAGE_MAP_TYPE_SERVER = "server";
  ...
  static public final PropertyKey IMAGE_MAP_TYPE_KEY =
    TYPE.registerKey("imageMapType", String.class, "none");
  ...
  /**
   * Construct an instance of the CoreImage.
   */
  public CoreImage()
  {
    super("org.apache.myfaces.trinidad.Image");
  }
  ...
  /**
   * Gets If a server-side image map is desired, specify "server" and place
   *               inside a CoreGoLink component.  The acceptable values
   *               are "server" or "none"; defaults to "none".
   *
   * @return  the new imageMapType value
   */
  final public String getImageMapType()
  {
    return ComponentUtils.resolveString(getProperty(IMAGE_MAP_TYPE_KEY), "none");
  }

  /**
   * Sets If a server-side image map is desired, specify "server" and place
   *               inside a CoreGoLink component.  The acceptable values
   *               are "server" or "none"; defaults to "none".
   * 
   * @param imageMapType  the new imageMapType value
   */
  final public void setImageMapType(String imageMapType)
  {
    setProperty(IMAGE_MAP_TYPE_KEY, (imageMapType));
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Object","org.apache.myfaces.trinidad.Image");
  }
}
