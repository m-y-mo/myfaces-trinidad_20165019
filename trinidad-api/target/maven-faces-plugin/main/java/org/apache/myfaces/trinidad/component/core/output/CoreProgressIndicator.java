 ...
 * </table>
 */
public class CoreProgressIndicator extends UIXProgress
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreProgressIndicator";

  /**
   * Construct an instance of the CoreProgressIndicator.
   */
  public CoreProgressIndicator()
  {
   ...
   * Construct an instance of the CoreProgressIndicator.
   */
  protected CoreProgressIndicator(
    String rendererType
    )
  {
    super(rendererType);
