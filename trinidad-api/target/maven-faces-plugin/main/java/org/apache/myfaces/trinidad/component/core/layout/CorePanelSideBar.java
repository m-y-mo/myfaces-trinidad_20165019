 ...
 * </table>
 */
public class CorePanelSideBar extends UIXPanel
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CorePanelSideBar";

  /**
   * Construct an instance of the CorePanelSideBar.
   */
  public CorePanelSideBar()
  {
    super("org.apache.myfaces.trinidad.SideBar");
  }

  /**
   * rendered above the children of the
   *                 panelSideBar.
   */
  ...
  /**
   * Gets the width of the panelSideBar in pixels or as a percentage.
   *
  ...
  /**
   * Sets the width of the panelSideBar in pixels or as a percentage.
   * 
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Panel","org.apache.myfaces.trinidad.SideBar");
  }
}
