 ...
 * </table>
 */
public class CoreInputListOfValues extends UIXSelectInput
{
  ...
  static public final PropertyKey SEARCH_DESC_KEY =
    TYPE.registerKey("searchDesc", String.class);
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreInputListOfValues";
   ...
   *            help text.
   *
   * @return  the new searchDesc value
   */
  final public String getSearchDesc()
  {
    return ComponentUtils.resolveString(getProperty(SEARCH_DESC_KEY));
  }
   ...
   *            help text.
   * 
   * @param searchDesc  the new searchDesc value
   */
  final public void setSearchDesc(String searchDesc)
  {
    setProperty(SEARCH_DESC_KEY, (searchDesc));
  }
   ...
   * Construct an instance of the CoreInputListOfValues.
   */
  protected CoreInputListOfValues(
    String rendererType
    )
  {
    super(rendererType);
