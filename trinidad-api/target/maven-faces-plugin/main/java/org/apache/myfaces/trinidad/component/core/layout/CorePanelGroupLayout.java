 ...
 * </table>
 */
public class CorePanelGroupLayout extends UIXPanel
{
  static public final String LAYOUT_HORIZONTAL = "horizontal";
  static public final String LAYOUT_DEFAULT = "default";
  ...
  static public final PropertyKey LAYOUT_KEY =
    TYPE.registerKey("layout", String.class);
  static public final String SEPARATOR_FACET = "separator";

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.Panel";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CorePanelGroupLayout";

  /**
   * Construct an instance of the CorePanelGroupLayout.
   */
  public CorePanelGroupLayout()
  {
    super("org.apache.myfaces.trinidad.GroupLayout");
  }
  ...
  /**
   * Gets Type of layout, either "vertical", "horizontal" (no wrapping) or"default" (horizontal with wrapping).
   *
   * @return  the new layout value
   */
  final public String getLayout()
  {
    return ComponentUtils.resolveString(getProperty(LAYOUT_KEY));
  }

  /**
   * Sets Type of layout, either "vertical", "horizontal" (no wrapping) or"default" (horizontal with wrapping).
   * 
   ...
   * Construct an instance of the CorePanelGroupLayout.
   */
  protected CorePanelGroupLayout(
    String rendererType
    )
  {
    super(rendererType);
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Panel","org.apache.myfaces.trinidad.GroupLayout");
  }
}
