 ...
 * </table>
 */
public class CoreProcessChoiceBar extends UIXProcess
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreProcessChoiceBar";

  /**
   * Construct an instance of the CoreProcessChoiceBar.
   */
  public CoreProcessChoiceBar()
  {
   ...
   * Construct an instance of the CoreProcessChoiceBar.
   */
  protected CoreProcessChoiceBar(
    String rendererType
    )
  {
    super(rendererType);
