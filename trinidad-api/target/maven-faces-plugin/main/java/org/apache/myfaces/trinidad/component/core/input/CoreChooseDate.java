 ...
 * </table>
 */
public class CoreChooseDate extends UIXChoose
{
  static public final FacesBean.Type TYPE = new FacesBean.Type(
    UIXChoose.TYPE);
  static public final PropertyKey MIN_VALUE_KEY =
    TYPE.registerKey("minValue", Date.class);
  static public final PropertyKey MAX_VALUE_KEY =
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreChooseDate";

  /**
   * Construct an instance of the CoreChooseDate.
   */
  public CoreChooseDate()
  {
    super("org.apache.myfaces.trinidad.Date");
  }
   ...
   *
   * @return  the new minValue value
   */
  final public Date getMinValue()
  {
    return (Date)getProperty(MIN_VALUE_KEY);
  }
   ...
   */
  final public void setMinValue(Date minValue)
  {
    setProperty(MIN_VALUE_KEY, (minValue));
  }
   ...
   * to allow the largest range of values to be accepted.
   *
   * @return  the new maxValue value
   */
  final public Date getMaxValue()
  {
    return (Date)getProperty(MAX_VALUE_KEY);
  }
   ...
   */
  final public void setMaxValue(Date maxValue)
  {
    setProperty(MAX_VALUE_KEY, (maxValue));
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Choose","org.apache.myfaces.trinidad.Date");
  }
}
