 ...
 * </table>
 */
public class CoreMessages extends UIXMessages
{
  ...
  static public final PropertyKey GLOBAL_ONLY_KEY =
    TYPE.registerKey("globalOnly", Boolean.class, Boolean.FALSE);

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.Messages";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreMessages";
  ...
  public CoreMessages()
  {
    super("org.apache.myfaces.trinidad.Messages");
  }
  ...
  /**
   * Gets whether to render all messages or just global messages. Normally
   ...
   */
  final public boolean isGlobalOnly()
  {
    return ComponentUtils.resolveBoolean(getProperty(GLOBAL_ONLY_KEY), false);
  }

  /**
   * Sets whether to render all messages or just global messages. Normally
   * global messages are rendered followed by messages for individual
   * components. If this attribute is set to true, only the global
   * messages will be rendered.
   * 
   ...
   */
  final public void setGlobalOnly(boolean globalOnly)
  {
    setProperty(GLOBAL_ONLY_KEY, globalOnly ? Boolean.TRUE : Boolean.FALSE);
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Messages","org.apache.myfaces.trinidad.Messages");
  }
}
