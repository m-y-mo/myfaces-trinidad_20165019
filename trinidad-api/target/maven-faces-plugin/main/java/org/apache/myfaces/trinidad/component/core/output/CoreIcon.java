 ...
 * </table>
 */
public class CoreIcon extends UIXObject
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreIcon";

  /**
   * Construct an instance of the CoreIcon.
   */
  public CoreIcon()
  {
    super("org.apache.myfaces.trinidad.Icon");
  }

  /**
   * Gets a  name identifying which icon should be rendered.
  ...
  /**
   * Sets a  name identifying which icon should be rendered.
   *               Valid values depend on the skin-family. Shortcut names
   *               exist for ".AFRequiredIcon", ".AFWarningIcon",
   *               ".AFInfoIcon", and ".AFErrorIcon". They are "required",
   *               "warning", "info", and "error" respectively.
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Object","org.apache.myfaces.trinidad.Icon");
  }
}
