 ...
 * </table>
 */
public class CoreSingleStepButtonBar extends UIXSingleStep
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreSingleStepButtonBar";

  /**
   * Construct an instance of the CoreSingleStepButtonBar.
   */
  public CoreSingleStepButtonBar()
  {
   ...
   * Construct an instance of the CoreSingleStepButtonBar.
   */
  protected CoreSingleStepButtonBar(
    String rendererType
    )
  {
    super(rendererType);
