...
public class CoreImportScript extends UIXComponentBase
{
  ...
  static public final PropertyKey NAMES_KEY =
    TYPE.registerKey("names", String[].class);

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.ImportScript";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreImportScript";
  ...
  {
    super("org.apache.myfaces.trinidad.ImportScript");
  }

  /**
   * Gets a series of function names
   *
   * @return  the new names value
   */
   ...
   * 
   * @param names  the new names value
   */
  final public void setNames(String[] names)
  {
    setProperty(NAMES_KEY, (names));
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.ImportScript","org.apache.myfaces.trinidad.ImportScript");
  }
}
