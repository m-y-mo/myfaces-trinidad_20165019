 ...
 * </table>
 */
public class CoreSelectManyListbox extends UIXSelectMany
{
  ...
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreSelectManyListbox";

  /**
   * Construct an instance of the CoreSelectManyListbox.
   */
  public CoreSelectManyListbox()
  {
  ...
  /**
   * Gets how many items should be visible.  Small values may be overridden if the platform cannot render a list of that size correctly.
   *
  ...
  /**
   * Sets how many items should be visible.  Small values may be overridden if the platform cannot render a list of that size correctly.
   * 
   ...
   * Construct an instance of the CoreSelectManyListbox.
   */
  protected CoreSelectManyListbox(
    String rendererType
    )
  {
    super(rendererType);
