 ...
 * </table>
 */
public class CoreOutputDocument extends UIXOutput
{
  static public final FacesBean.Type TYPE = new FacesBean.Type(
    UIXOutput.TYPE);
  static public final PropertyKey TITLE_CLASS_KEY =
    TYPE.registerKey("titleClass", String.class);
  static public final PropertyKey SEPARATOR_CLASS_KEY =
    TYPE.registerKey("separatorClass", String.class);
  ...
  static public final String SEPARATOR_FACET = "separator";

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.Output";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreOutputDocument";

  /**
   * Construct an instance of the CoreOutputDocument.
   */
  public CoreOutputDocument()
  {
   ...
   */
  final public UIComponent getTitle()
  {
    return getFacet(TITLE_FACET);
  }
  ...
  final public void setTitle(UIComponent titleFacet)
  {
    getFacets().put(TITLE_FACET, titleFacet);
  }

  /**
   * The object used to separate paragraphs of the document.
   */
  ...
  /**
   * Gets the style class of the title. This property will be
   *          considered only if a title facet is used.
   *
   * @return  the new titleClass value
   */
  final public String getTitleClass()
  {
    return ComponentUtils.resolveString(getProperty(TITLE_CLASS_KEY));
  }

  /**
   * Sets the style class of the title. This property will be
   *          considered only if a title facet is used.
   * 
   * @param titleClass  the new titleClass value
   */
  final public void setTitleClass(String titleClass)
  {
    setProperty(TITLE_CLASS_KEY, (titleClass));
  }

  /**
   * Gets the style class of the separator. This property will be
   *          considered only if a separator facet is used.
   *
   * @return  the new separatorClass value
   */
  final public String getSeparatorClass()
  {
    return ComponentUtils.resolveString(getProperty(SEPARATOR_CLASS_KEY));
  }

  /**
   * Sets the style class of the separator. This property will be
   *          considered only if a separator facet is used.
   * 
   * @param separatorClass  the new separatorClass value
   */
  final public void setSeparatorClass(String separatorClass)
  {
    setProperty(SEPARATOR_CLASS_KEY, (separatorClass));
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Output","org.apache.myfaces.trinidad.Document");
  }
}
