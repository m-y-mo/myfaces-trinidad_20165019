 ...
 * </table>
 */
public class CoreStatusIndicator extends UIXObject
{
  ...
  static public final String BUSY_FACET = "busy";

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.Object";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CoreStatusIndicator";

  /**
   * Construct an instance of the CoreStatusIndicator.
   */
  public CoreStatusIndicator()
  {
    super("org.apache.myfaces.trinidad.StatusIndicator");
  }

  /**
   * Content to be rendered when the page is ready. If this facet is
   *                  specified, no default icon is going to be rendered.
   */
  final public UIComponent getReady()
  {
    return getFacet(READY_FACET);
  }
  ...
  final public void setReady(UIComponent readyFacet)
  {
    getFacets().put(READY_FACET, readyFacet);
  }
   ...
   *                  be rendered.
   */
  final public UIComponent getBusy()
  {
    return getFacet(BUSY_FACET);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  final public void setBusy(UIComponent busyFacet)
  {
    getFacets().put(BUSY_FACET, busyFacet);
  }
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Object","org.apache.myfaces.trinidad.StatusIndicator");
  }
}
