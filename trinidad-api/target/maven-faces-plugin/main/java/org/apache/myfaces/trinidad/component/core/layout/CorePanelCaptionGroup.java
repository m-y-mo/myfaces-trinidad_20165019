 ...
 * </table>
 */
public class CorePanelCaptionGroup extends UIXPanel
{
  ...
  static public final PropertyKey CAPTION_TEXT_KEY =
    TYPE.registerKey("captionText", String.class);
  static public final String CAPTION_FACET = "caption";

  static public final String COMPONENT_FAMILY =
    "org.apache.myfaces.trinidad.Panel";
  static public final String COMPONENT_TYPE =
    "org.apache.myfaces.trinidad.CorePanelCaptionGroup";

  /**
   * Construct an instance of the CorePanelCaptionGroup.
   */
  public CorePanelCaptionGroup()
  {
    super("org.apache.myfaces.trinidad.PanelCaptionGroup");
  }

  /**
   * Content to be rendered as the caption for the group content.  The
   ...
   */
  final public UIComponent getCaption()
  {
    return getFacet(CAPTION_FACET);
  }
  ...
  final public void setCaption(UIComponent captionFacet)
  {
    getFacets().put(CAPTION_FACET, captionFacet);
  }
  ...
  /**
   * Gets The text to be rendered as the caption for the group content.
   *
   * @return  the new captionText value
   */
  final public String getCaptionText()
  {
    return ComponentUtils.resolveString(getProperty(CAPTION_TEXT_KEY));
  }

  /**
   * Sets The text to be rendered as the caption for the group content.
   * 
   * @param captionText  the new captionText value
   */
  final public void setCaptionText(String captionText)
  {
    setProperty(CAPTION_TEXT_KEY, (captionText));
  }
   ...
   * Construct an instance of the CorePanelCaptionGroup.
   */
  protected CorePanelCaptionGroup(
    String rendererType
    )
  {
    super(rendererType);
  ...
  static
  {
    TYPE.lockAndRegister("org.apache.myfaces.trinidad.Panel","org.apache.myfaces.trinidad.PanelCaptionGroup");
  }
}
